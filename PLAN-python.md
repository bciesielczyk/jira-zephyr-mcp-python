...
- [X] **Implement configuration layer**: load environment variables and secret stores with `pydantic` models, define validation rules, support multiple config sources, and write unit tests.
